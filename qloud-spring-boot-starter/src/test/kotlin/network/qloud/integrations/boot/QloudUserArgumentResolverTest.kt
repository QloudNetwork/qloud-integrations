...
class QloudUserArgumentResolverTest {
    ...
    private val resolver = QloudUserArgumentResolver()
    ...
    @Test
    fun `resolveArgument returns QloudUser if authentication is JwtAuthenticationToken`() {
        ...
        assertThat(user).isEqualToComparingFieldByField(JwtQloudUser(JWT_AUTHENTICATION_TOKEN))
    }
